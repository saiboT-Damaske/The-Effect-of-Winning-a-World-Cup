...
# Optional write
write_csv(df_base_long, "Data/oecd_source/oecd_qna_base_long_q_nsa_1960_2024.csv")
...
write_csv(feature_dict, "Data/oecd_metadata/oecd_feature_dictionary.csv")
...
write_csv(df_base_wide, "Data/oecd_processed/oecd_base_panel_wide.csv")
...
write_csv(df_base_wide_named, "Data/oecd_processed/oecd_base_panel_wide_named.csv")
...
export_country_wide_csvs(df_base_wide_named, out_dir = "Data/oecd_processed/oecd_by_country_wide")
...
write_csv(coverage_span_wide, "Data/oecd_metadata/oecd_country_feature_timespans_wide.csv")
...
write_csv(coverage_span_wide_named, "Data/oecd_metadata/oecd_country_feature_timespans_wide_named.csv")
...
DEU <- read_csv("Data/oecd_processed/oecd_by_country_wide/DEU.csv", show_col_types = FALSE)
head(DEU)
