...
# 
#
# I define a underperformer team as a team that had a top 10 ELO ranking when the world cup started, 
# but then got knocked out in the group stages. 
# Hence, I need the following data sources:
#
...
#   then to determine the relevancy of using ELO instead of FIFA rankings
...
# ==========================================================
  ...
  # country codes from ELO vs OECD data set
  # list generated by LLM
elo_to_iso3 <- c(
  "AE" = "ARE",  # UAE
  "AO" = "AGO",  # Angola
  "AR" = "ARG",  # Argentina
...
# mapping ELO codes to full country names (also generated)
elo_to_name <- c(
...
# calls from the elo rankings webpage for each world cup year
...
# Now I want to check if using ELO rankings is a viable source for underprformer
# since FIFA rankings are only available from 1993 but my data starts at 1961
# Pre-tournament FIFA ranking dateIds (via inside.fifa.com API)
# from the webpage the year ids are irregular and have to be entered manually
