...
\label{fig:ext_underperformer_es_all}
\begin{tablenotes}
\textit{Notes}: Dependent variable: $\Delta_4 \ln Y_{c,t}$ for each feature.  Treatment = top-10 pre-tournament ELO rating, eliminated in group stage.  19~treated countries, 23~events, 8{,}633~observations.  Error bars: 95\%~CI.  Reference: $l = 0$ (Q2 of WC year).  Endpoints binned at $\pm 16$.
\end{tablenotes}
\end{figure}
